...
autoketik = true;
prefixStatus = true;
targetpc = "6285157160906", "6281212083401"; 
owner = "6285157160906", "6281212083401"; 
fakeyoi = "Naufal tutor"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6285157160906@s.whatsapp.net`]
       ...
       const daftar3 = [
          {
            buttonId: `verify`,
            buttonText: {
              displayText: `DAFTAR dulu kontol 🗿☕`,
            },
            type: 1,
          },]
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       ...
       menu = `
Hai Kak @${sender.split('@')[0]}\n\nKlo pakek wa mod yg bener pilih yg bener🗿☕ klo wa mod/bisnis silahkan ketik #menu\nmasuk sini🛐\nbit.ly/NaufalXAtak`
sendButLocation(from, `${menu}`,`Hii kontol 🗿☕ wkwkw @${sender.split('@')[0]}`, {jpegThumbnail:iye}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'ALL MENU🍂︎'},type:1},{buttonId:`${prefix}command`,buttonText:{displayText:'COMMAND💭︎'},type:1},{buttonId:`${prefix}credit`,buttonText:{displayText:'𝙏𝙝𝙖𝙣𝙠𝙨 𝙏𝙤☻'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
break
        case 'KonX':
        case 'akmal':
        case 'allmenu':
...
└──────────────────❒
`
sendButLocation(from, `${menu}`,`𝘽𝙤𝙩 𝘽𝙮 @${dtod.split("@")[0]}`, {jpegThumbnail:iye}, [{buttonId:`${prefix}command`,buttonText:{displayText:'𝙈𝙚𝙣𝙪 📚 シ︎'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'𝙎𝙀𝙒𝘼 𝘽𝙊𝙏🍃シ︎︎'},type:1},{buttonId:`${prefix}credit`,buttonText:{displayText:'𝙏𝙝𝙖𝙣𝙠𝙨 𝙏𝙤☻︎'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
break		
case 'credit':
   dtod = '6285157160906'
   dtod1 = '6281212083401'
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               ...
               await sleep(1000)
               titid = 'Klo sv, sv aja mau sv back? chat aja yg sopan🗿'
...
case 'script':
		case 'sc':
		case 'sourcecode':
		KonX.sendMessage(from, { text: "Subscribe dulu yt owner gua : Naufal tutor\nnah baru chat owner minta baik²🗿", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'bot':
		case 'b':
		...
		case 'grup':
		case 'grupbot':
		KonX.sendMessage(from, { text: "*NOH GROUP² BOT/OWNER* : \n1. https://chat.whatsapp.com/CN0b6MId8jlJeyBs0SmS7Y\n2. https://chat.whatsapp.com/JEBPQ1TrM8bH4KG7BDvEGu", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'scbot':
		case 'scini':
		KonX.sendMessage(from, { text: "blom gua buat nanti gua kasih kok🗿🙏🏻", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'github':
		case 'githubown':
		KonX.sendMessage(from, { text: "Nih gua kasih github owner gua https://github/naufal132", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'yt':
		case 'ytown':
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
 listMsg = {
 buttonText: 'LIST MENU UPDATE',
 footerText: 'Silahkan pilih list menu di bawah︎',
 description: `Hai kak @${sender.split('@')[0]}, Silahkan pilih updatemenu disini`,
 sections: [
                     {
                      "title": `${jam} - ${week} ${weton} - ${date}`,
 rows: [
